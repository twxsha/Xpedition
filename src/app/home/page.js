...
const Home = () => {
    ...
    const handleSaveClick = async () => {
        ...
        try {
            ...
            const userDocRef = doc(db, "xpeditions", auth.currentUser.email);
            ...
            await setDoc(doc(subCollectionRef), { // Use doc(subCollectionRef) to create a new document within the subcollection
                hotels: "twish",
                flights: "Lovelace",
                activities: 1815,
                packing: "",
